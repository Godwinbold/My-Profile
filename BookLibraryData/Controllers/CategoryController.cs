...
namespace BookLibraryData.Controllers
{
    public class CategoryController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Name,Id,CreatedAt,UpdatedAt")] Category category)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("Name,Id,CreatedAt,UpdatedAt")] Category category)
        {
            if (id != category.Id)
            {
                return NotFound();
