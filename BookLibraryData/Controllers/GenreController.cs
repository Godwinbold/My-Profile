...
namespace BookLibraryData.Controllers
{
    public class GenreController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Name,Id,CreatedAt,UpdatedAt")] Genre genre)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("Name,Id,CreatedAt,UpdatedAt")] Genre genre)
        {
            if (id != genre.Id)
            {
                return NotFound();
